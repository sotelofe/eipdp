...
@Component({
  selector: 'app-altafuera',
  templateUrl: './altafuera.component.html',
  styleUrls: ['./altafuera.component.scss']
})
export class AltafueraComponent implements OnInit, AfterViewInit{
  ...
  altaUsuario():void{
    ...
    if (this.formUsuario.contrasena.length<8 ) {
      ...
      this.toastr.error('Error, La contraseña debe contener al menos una mayúscula, una minúscula, un número y un caracter especial', '', { positionClass: 'toast-top-full-width', closeButton: true });
      return;

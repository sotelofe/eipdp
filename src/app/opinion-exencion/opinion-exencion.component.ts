...
@Component({
  selector: 'app-opinion-exencion',
  templateUrl: './opinion-exencion.component.html',
  styleUrls: ['./opinion-exencion.component.scss']
})
export class OpinionExencionComponent implements OnInit {
  ...
  enviar(){
    ...
    this.spinner.show();
    this.excencionService.registrarOpinion(this.peticionRespuesta,folio).subscribe(
      result => {

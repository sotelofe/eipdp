...
@Component({
  selector: 'app-verdictamen',
  templateUrl: './verdictamen.component.html',
  styleUrls: ['./verdictamen.component.scss']
})
export class VerdictamenComponent implements OnInit {
  ...
  iniciaPrecarga(con:CuestionarioDTO[]){
    con.forEach((c)=>{
      ...
      if(c.pregunta!=null){
          if(c.pregunta == 18 && c.subpregunta == 1){

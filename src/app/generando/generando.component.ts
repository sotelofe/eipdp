...
@Component({
  ...
  templateUrl: './generando.component.html',
  styleUrls: ['./generando.component.scss']
})
export class GenerandoComponent implements OnInit {
  ...
  enviar(){
    ...
    this.spinner.show();
    this.flujoService.subirOpinionTecnica(this.documento).subscribe(
      result => {

            this.response = result;
            if (this.response !=null ) {
                if(this.response.estatus === "ok"){
                  this.toastr.success('La Opinión Técnica se ha enviado de forma correcta', 'Aviso', { positionClass: 'toast-top-full-width', closeButton: true });

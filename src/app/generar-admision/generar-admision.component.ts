...
@Component({
  selector: 'app-generar-admision',
  templateUrl: './generar-admision.component.html',
  styleUrls: ['./generar-admision.component.scss']
})
export class GenerarAdmisionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log(this.folioConsultafUno);
  }
  ...
  enviar(){
    ...
    this.spinner.show();
    this.flujoService.subirAcuerdoAdmision(this.documento).subscribe(
      result => {

...
@Component({
  selector: 'app-riados',
  templateUrl: './riados.component.html',
  styleUrls: ['./riados.component.scss']
})
export class RiadosComponent implements OnInit {
  ...
  enviar(){
    ...
    this.spinner.show();
    this.flujoService.subirRiaRequerida2(this.documento).subscribe(
      result => {
